...
//inserting roles
INSERT INTO `roles` (`role_id`, `role_name`, `role_description`, `is_teaching_role`) VALUES (NULL, 'Admin', 'all rights', '0'), (NULL, 'asst', 'full', '0');

//insert into users
INSERT INTO `users` (`user_id`, `username`, `email`, `password_hash`, `role_id`, `access_level`, `access_start_date`, `is_active`, `created_at`, `last_login`, `last_message_check`) VALUES (NULL, 'charles', 'charles@gmail.com', 'charles', '1', 'admin', '2025-04-25', '1', current_timestamp(), '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'), 
(NULL, 'jab', 'jab@gmail.com', 'jab', '1', 'admin', '2025-04-25', '1', current_timestamp(), '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000');
