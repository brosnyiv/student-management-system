    ...
    <div id="CS301-resources" class="tab-content">
        ...
        <div class="resource-item">
            ...
            <div>
                ...
                <p>Location: CS Building, Room 150 | Hours: Mon-Fri 10:00-18:00</p>
            </div>
        </div>
        ...
        <div class="resource-item">
            ...
            <div>
                ...
                <p>Open access computer lab with TA support.</p>
                <p>Location: CS Lab Building, Room 200 | Hours: 24/7 with student ID</p>
            </div>
        </div>
    </div>
